...
namespace DoomLauncher
{
    static class Program
    {
        ...
        { 
            ...
            nameof(LaunchArgs.LaunchGameProfileID),
            nameof(LaunchArgs.LaunchSourcePortID),
            nameof(LaunchArgs.LaunchIWadID),
            nameof(LaunchArgs.EditGameFileID),
        };

        private static readonly string[] FlagKeys = new string[]
        {
            nameof(LaunchArgs.LaunchDefaultProfile),
            nameof(LaunchArgs.OpenSettings),
