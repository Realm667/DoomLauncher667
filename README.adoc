...
To **migrate**, extract Doom Launcher 667 and use the integrated function
at the first launch of the software, it will guide you through the process.
...
* XML-based user themes including various choosable custom themes, automatic 
  text-contrast protection and English, German, French and Spanish localization;
...
* migration from hobomaster22's original Doom Launcher at startup, alternatively
  scanning for mods, iwads and sourceports in their responsive directories with
...
* `Data/TileImages/colored` and `Data/TileImages/grayscale` contain editable
  placeholder artwork. Missing defaults are restored without overwriting
  user-modified files;
